...
import { _ as __nuxt_component_1$1 } from './Tag-1fb4515b.mjs';
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  _push(`<svg${ssrRenderAttrs(mergeProps({
    ...
    height: "1.3em",
    viewBox: "0 0 24 24"
  }, _attrs))}><path fill="currentColor" d="M15.835 11.63L9.205 5.2C8.79 4.799 8 5.042 8 5.57v12.86c0 .528.79.771 1.205.37l6.63-6.43a.498.498 0 0 0 0-.74"></path></svg>`);
}
...
const _sfc_main$5 = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_IconsTag = __nuxt_component_1$1;
      _push(`<!--[-->`);
      ssrRenderList(unref(news), (news2) => {
        _push(`<div class="flex mb-10 cursor-pointer" data-v-56a1fb27><div class="h-[120px] sm:h-[160px] w-[140px] sm:w-[220px] md:w-[260px] flex-none" data-v-56a1fb27>`);
        ...
        _push(`</div><div class="block pl-4" data-v-56a1fb27><div class="text-md md:text-xl font-semibold" data-v-56a1fb27><span class="line-clamp-2" data-v-56a1fb27>${ssrInterpolate(news2.title)}</span></div><div class="text-sm md:text-base block sm:flex items-center font-medium mt-2" data-v-56a1fb27><div class="flex items-center" data-v-56a1fb27>`);
        _push(ssrRenderComponent(_component_IconsDate, { class: "flex-none" }, null, _parent));
        _push(`<span class="ml-1" data-v-56a1fb27>${ssrInterpolate(unref(moment)(news2.created_at).format("LL"))}</span></div><div class="flex items-center sm:ml-2 max-[500px]:mt-1" data-v-56a1fb27>`);
        _push(ssrRenderComponent(_component_IconsTag, { class: "flex-none" }, null, _parent));
        _push(`<span class="ml-1" data-v-56a1fb27>${ssrInterpolate(news2.name)}</span></div></div><div class="mt-2" data-v-56a1fb27><span class="line-clamp-2 sm:line-clamp-3" data-v-56a1fb27>${ssrInterpolate(news2.description)}</span></div></div></div>`);
      });
      _push(`<!--]-->`);
    };
  }
...
const __nuxt_component_2 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["__scopeId", "data-v-56a1fb27"]]);
const _sfc_main$4 = {
...
const _sfc_main$2 = {
  ...
  async setup(__props) {
    ...
    ref(null);
    const { data } = ([__temp, __restore] = withAsyncContext(() => $fetch("/api/image-gallery?limit=8")), __temp = await __temp, __restore(), __temp);
    images.value = data;
    return (_ctx, _push, _parent, _attrs) => {
      const _component_IconsArrowRight = __nuxt_component_1;
      const _component_v_img = resolveComponent("v-img");
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "block col-span-4" }, _attrs))} data-v-3c1ceb75><div class="text-[#0088CC] flex items-center cursor-pointer border-[#0088CC] border-b-2 mb-6 text-xl md:text-2xl font-semibold py-3" data-v-3c1ceb75><span data-v-3c1ceb75>Galeri Desa</span>`);
      _push(ssrRenderComponent(_component_IconsArrowRight, null, null, _parent));
      _push(`</div><div id="gallery" class="sm:grid rounded-lg hidden grid-cols-1 md:grid-cols-4 mb-2 gap-6" data-v-3c1ceb75><!--[-->`);
      ssrRenderList(unref(images), (image, key) => {
        _push(`<a class="rounded-lg h-full w-full relative"${ssrRenderAttr("href", image.url)} data-pswp-width="600" data-pswp-height="400" target="_blank" rel="noreferrer" data-v-3c1ceb75><div class="hidden-caption-content" data-v-3c1ceb75>${ssrInterpolate(image.description)}</div>`);
        _push(ssrRenderComponent(_component_v_img, {
          "lazy-src": image.url,
          class: "rounded-md",
          cover: "",
        ...
        _push(`<div class="rounded-b-lg z-10 py-1 backdrop-blur-xl opacity-90 pl-2 bg-[#0088CC] bottom-0 absolute w-full text-white" data-v-3c1ceb75><p class="truncate text-sm md:text-base" data-v-3c1ceb75>${ssrInterpolate(image.description)}</p></div></a>`);
      });
      _push(`<!--]--></div><div id="gallery" class="sm:hidden rounded-lg grid grid-cols-1 md:grid-cols-4 mb-2 gap-6" data-v-3c1ceb75>`);
              ...
              _push2(ssrRenderComponent(unref(SwiperSlide), { class: "relative rounded-lg" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<div class="text-sm sm:text-lg font-normal rounded-b-md z-10 py-1 backdrop-blur-xl opacity-90 pl-2 bg-[#0088CC] bottom-0 absolute w-full text-white" data-v-3c1ceb75${_scopeId2}><span data-v-3c1ceb75${_scopeId2}>${ssrInterpolate(image.description)}</span></div>`);
                  } else {
                    return [
...
const __nuxt_component_5 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-3c1ceb75"]]);
const _sfc_main$1 = {
  __name: "Location",
  __ssrInlineRender: true,
  async setup(__props) {
...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_IconsArrowRight = __nuxt_component_1;
      const _component_HomeLatestNews = __nuxt_component_2;
      const _component_HomeLatestAnnouncement = __nuxt_component_3;
      const _component_HomeLatestActivities = __nuxt_component_4;
      const _component_HomeGallery = __nuxt_component_5;
      const _component_v_img = resolveComponent("v-img");
      const _component_HomeLocation = __nuxt_component_6;
      ...
      _push(`<div class="block pb-6 px-[2rem] sm:px-[6rem] md:px-[3rem] lg:px-[10rem] xl:px-[14rem] bg-white pt-6"><div class="grid grid-cols-1 md:grid-cols-6 md:gap-x-12"><div class="block col-span-1 md:col-span-4"><div class="text-[#0088CC] flex items-center cursor-pointer border-[#0088CC] border-b-2 mb-6 text-xl md:text-2xl font-semibold py-3"><span>Berita Terkini</span>`);
      _push(ssrRenderComponent(_component_IconsArrowRight, null, null, _parent));
      _push(`</div>`);
      _push(ssrRenderComponent(_component_HomeLatestNews, null, null, _parent));
      _push(`</div><div class="col-span-2"><div class="text-[#0088CC] flex items-center cursor-pointer border-[#0088CC] border-b-2 mb-6 text-xl md:text-2xl font-semibold py-3"><span>Pengumuman</span>`);
      _push(ssrRenderComponent(_component_IconsArrowRight, null, null, _parent));
      _push(`</div>`);
      _push(ssrRenderComponent(_component_HomeLatestAnnouncement, null, null, _parent));
      _push(`<div class="text-[#0088CC] flex items-center cursor-pointer border-[#0088CC] border-b-2 mb-6 text-xl md:text-2xl font-semibold py-3"><span>Agenda Kegiatan</span>`);
      _push(ssrRenderComponent(_component_IconsArrowRight, null, null, _parent));
      _push(`</div>`);
      ...
      _push(`<div class="col-span-2"><div class="text-[#0088CC] cursor-pointer flex items-center struktur border-[#0088CC] border-b-2 mb-6 text-xl md:text-2xl font-semibold py-3"><span>Struktur Organisasi</span>`);
      _push(ssrRenderComponent(_component_IconsArrowRight, null, null, _parent));
      _push(`</div><div class="font-medium text-white px-2 rounded-md">`);
      _push(ssrRenderComponent(unref(Swiper), {
        autoplay: {
          delay: 4e3,
          disableOnInteraction: false
...
//# sourceMappingURL=index-5b19829f.mjs.map
