...
import { resolveComponent, withCtx, createTextVNode, createVNode, mergeProps, openBlock, createBlock, useSSRContext } from 'vue';
...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="mb-3 mt-5 text-lg font-medium my-1">Thumbnail</div>`);
...
//# sourceMappingURL=add-fb43a791.mjs.map
