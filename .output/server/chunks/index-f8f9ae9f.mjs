...
const _sfc_main = /* @__PURE__ */ Object.assign(__default__, {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_v_dialog, {
        modelValue: _ctx.modalRemovePotensiCategory,
        "onUpdate:modelValue": ($event) => _ctx.modalRemovePotensiCategory = $event,
        width: "auto"
      }, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_v_card, {
              ...
              title: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex items-center justify-between"${_scopeId2}><div class="text-xl font-semibold"${_scopeId2}><span${_scopeId2}>Hapus Kategori Potensi Desa?</span></div><div class="cursor-pointer"${_scopeId2}><svg xmlns="http://www.w3.org/2000/svg" width="2em" height="2em" viewBox="0 0 24 24"${_scopeId2}><g fill="none" stroke="black" stroke-width="1.5"${_scopeId2}><circle cx="12" cy="12" r="10"${_scopeId2}></circle><path stroke-linecap="round" d="m14.5 9.5l-5 5m0-5l5 5"${_scopeId2}></path></g></svg></div></div>`);
                } else {
                  return [
                    createVNode("div", { class: "flex items-center justify-between" }, [
                      createVNode("div", { class: "text-xl font-semibold" }, [
                        createVNode("span", null, "Hapus Kategori Potensi Desa?")
                      ]),
                      createVNode("div", {
                        onClick: ($event) => _ctx.modalRemovePotensi = false,
                        class: "cursor-pointer"
              ...
              text: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div${_scopeId2}><span${_scopeId2}>Kategori Potensi Desa yang dihapus tidak bisa dikembalikan kembali.</span></div>`);
                } else {
                  return [
                    createVNode("div", null, [
                      createVNode("span", null, "Kategori Potensi Desa yang dihapus tidak bisa dikembalikan kembali.")
                    ])
                  ];
                }
              }),
              actions: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_v_btn, {
                    variant: "flat",
                    onClick: _ctx.removeKategoriPotensi,
                    color: "#FC4100",
                    class: "w-fit mt-6 text-white px-3 mx-1 mb-2 py-2 text-md"
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
          ...
          if (_push2) {
            ...
            return [
              createVNode("div", { class: "flex justify-end" }, [
                ("useParseJWT" in _ctx ? _ctx.useParseJWT : unref(useParseJWT))().value.is_admin == 1 || ("useParseJWT" in _ctx ? _ctx.useParseJWT : unref(useParseJWT))().value.user == item.user_id ? (openBlock(), createBlock("div", {
                  key: 0,
                  onClick: ($event) => _ctx.$router.push("/dashboard/potensi-desa/category/edit?id=" + item.uuid),
                  class: "cursor-pointer mx-1"
                }, [
                  (openBlock(), createBlock("svg", {
                    xmlns: "http://www.w3.org/2000/svg",
                ...
                ("useParseJWT" in _ctx ? _ctx.useParseJWT : unref(useParseJWT))().value.is_admin == 1 || ("useParseJWT" in _ctx ? _ctx.useParseJWT : unref(useParseJWT))().value.user == item.user_id ? (openBlock(), createBlock("div", {
                  key: 1,
                  class: "cursor-pointer",
                  onClick: ($event) => _ctx.openModalRemoveKategoriPotensi(item.uuid)
                }, [
                  (openBlock(), createBlock("svg", {
                    xmlns: "http://www.w3.org/2000/svg",
                    width: "1.5em",
...
//# sourceMappingURL=index-f8f9ae9f.mjs.map
