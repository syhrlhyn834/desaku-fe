...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="grid grid-cols-1 md:grid-cols-6 md:gap-x-12 pb-6"><div class="block col-span-1 md:col-span-4 pb-6"><div class="text-[#0088CC] border-[#0088CC] border-b-2 mb-6 text-xl md:text-2xl font-semibold py-3"><span>Pengumuman</span></div><!--[-->`);
      ssrRenderList(unref(announcements), (announcement) => {
        _push(`<div class="cursor-pointer flex mb-7"><div class="block"><div class="text-base md:text-lg font-semibold"><span class="line-clamp-2">${ssrInterpolate(announcement.title)}</span></div><div class="text-sm md:text-base block sm:flex items-center font-medium mt-2"><div class="flex items-center">`);
        _push(ssrRenderComponent(_component_IconsDate, { class: "flex-none" }, null, _parent));
        _push(`<span class="ml-1">${ssrInterpolate(unref(moment)(announcement.created_at).format("LL"))}</span></div><div class="flex items-center sm:ml-2 max-[500px]:mt-1">`);
        _push(ssrRenderComponent(_component_IconsAuthor, { class: "flex-none" }, null, _parent));
        _push(`<span class="ml-1">${ssrInterpolate(announcement.name)}</span></div></div><div class="mt-3"><span class="text-md sm:text-base line-clamp-2 sm:line-clamp-3">${ssrInterpolate(announcement.description)}</span></div></div></div>`);
      });
      _push(`<!--]-->`);
...
//# sourceMappingURL=index-0455f967.mjs.map
