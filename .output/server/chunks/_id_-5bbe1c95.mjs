...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="pb-12 grid grid-cols-1 md:grid-cols-6 md:gap-x-12 gap-y-8"><div class="block col-span-1 md:col-span-4"><div class="text-[#0088CC] mb-2 text-2xl md:text-2xl font-semibold py-3"><span>${ssrInterpolate(unref(post).title)}</span></div><div class="text-sm md:text-base block sm:flex items-center font-normal mt-2 mb-4"><div class="flex items-center max-[600px]:mb-2">`);
      _push(ssrRenderComponent(_component_IconsDate, { class: "flex-none" }, null, _parent));
      _push(`<span class="ml-1">${ssrInterpolate(unref(moment)(unref(post).date).format("DD MMM YYYY"))}</span></div><div class="flex items-center sm:ml-2">`);
      _push(ssrRenderComponent(_component_IconsLocation, { class: "flex-none" }, null, _parent));
      _push(`<span class="ml-1">${ssrInterpolate(unref(post).location)}</span></div></div><div class="quill-content">${unref(post).content}</div></div><div class="col-span-2">`);
...
//# sourceMappingURL=_id_-5bbe1c95.mjs.map
