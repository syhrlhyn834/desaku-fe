import { ref, watch, reactive, onMounted, onUnmounted, computed, toRefs, useSSRContext, resolveComponent, withCtx, createTextVNode, createVNode, openBlock, createBlock, mergeProps, unref, createCommentVNode, Fragment, renderList } from 'vue';
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_v_snackbar, {
        modelValue: toastError.value,
        "onUpdate:modelValue": ($event) => toastError.value = $event,
        color: "red",
        timeout: 3e3
      }, {
        actions: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_v_btn, {
              color: "white",
              variant: "text",
              onClick: ($event) => toastError.value = false
            }, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(` Terjadi kesalahan saat mengupload gambar, pastikan sesuai ketentuan! `);
          } else {
            return [
              createTextVNode(" Terjadi kesalahan saat mengupload gambar, pastikan sesuai ketentuan! ")
            ];
          }
        }),
        _: 1
              ...
              text: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (currentTab.value == "listImage") {
                    ...
                    _push3(`</div><div class="mt-3"${_scopeId2}><span${_scopeId2}>tipe: webp,svg,jpeg,png,jpg | max: 1mb</span></div></div></div></div>`);
                  }
                  _push3(`</div>`);
                } else {
                  return [
                      ...
                      currentTab.value == "listImage" ? (openBlock(), createBlock("div", {
                        ...
                        createVNode("div", mergeProps({ class: "flex justify-center items-center h-[300px]" }, unref(getRootProps)()), [
                          ...
                          createVNode("div", null, [
                            createVNode("p", { class: "text-xl font-semibold text-center" }, "Drop files to upload"),
                            ...
                            createVNode("div", { class: "mt-3" }, [
                              createVNode("span", null, "tipe: webp,svg,jpeg,png,jpg | max: 1mb")
                            ])
                          ])
                        ], 16)
                      ]))
...
//# sourceMappingURL=MediaLibrary-4de97d84.mjs.map
