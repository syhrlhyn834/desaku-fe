import { _ as __nuxt_component_0 } from './MediaLibrary-4de97d84.mjs';
...
import { resolveComponent, withCtx, createTextVNode, createVNode, mergeProps, openBlock, createBlock, createCommentVNode, useSSRContext } from 'vue';
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_component_v_menu, {
              modelValue: _ctx.menuDate,
              "onUpdate:modelValue": ($event) => _ctx.menuDate = $event,
              transition: "slide-y-transition"
            }, {
              activator: withCtx(({ props }, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_v_text_field, mergeProps({ clearable: "" }, props, {
                    rules: [(v) => !!v || "Field is required"],
                  ...
                  return [
                    createVNode(_component_v_text_field, mergeProps({ clearable: "" }, props, {
                      rules: [(v) => !!v || "Field is required"],
                      modelValue: _ctx.form.date,
                      "onUpdate:modelValue": ($event) => _ctx.form.date = $event,
                      variant: "outlined",
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_component_v_date_picker, {
                    modelValue: _ctx.date,
                    "onUpdate:modelValue": [($event) => _ctx.date = $event, _ctx.formatDate],
                    min: _ctx.today,
                    label: "Select a date"
                  }, null, _parent3, _scopeId2));
                } else {
            ...
            _push2(`</div><div class="mb-3 mt-5 text-lg font-medium my-1"${_scopeId}>Thumbnail</div>`);
            ...
            return [
              createVNode("div", { class: "card" }, [
                ...
                createVNode("div", { class: "mb-3 mt-5 text-lg font-medium my-1" }, "Thumbnail"),
...
//# sourceMappingURL=edit-75e75ee0.mjs.map
