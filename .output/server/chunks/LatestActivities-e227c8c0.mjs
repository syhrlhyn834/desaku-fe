...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="${ssrRenderClass([_ctx.$vuetify.display.mobile ? "mt-5" : "mt-0", "text-[#0088CC] border-[#0088CC] border-b-2 mb-6 text-xl sm:text-2xl font-semibold py-3"])}" data-v-bb3114cd><span data-v-bb3114cd>Kegiatan Terbaru</span></div><div class="mb-10" data-v-bb3114cd><!--[-->`);
      ssrRenderList(unref(activities), (activity) => {
        _push(`<div class="cursor-pointer px-0 py-3 flex" data-v-bb3114cd><div class="w-[140px] flex-none" data-v-bb3114cd>`);
        ...
        _push(`</div><div class="block ml-3" data-v-bb3114cd><div class="text-[#0088CC] text-base font-medium" data-v-bb3114cd><span class="line-clamp-2" data-v-bb3114cd>${ssrInterpolate(activity.title)}</span></div><div class="mt-1" data-v-bb3114cd><span data-v-bb3114cd>${ssrInterpolate(unref(moment)(activity.date).format("LL"))}</span></div></div></div>`);
      });
      _push(`<!--]--></div><!--]-->`);
    };
  }
...
const __nuxt_component_3 = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bb3114cd"]]);

export { __nuxt_component_2 as _, __nuxt_component_3 as a };
//# sourceMappingURL=LatestActivities-e227c8c0.mjs.map
