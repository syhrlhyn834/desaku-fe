...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<span class="ml-1">Ditulis oleh ${ssrInterpolate(unref(post).created_by)}</span></div></div><div class="quill-content">${unref(post).content}</div></div><div class="col-span-2">`);
...
//# sourceMappingURL=_id_-20ff3321.mjs.map
