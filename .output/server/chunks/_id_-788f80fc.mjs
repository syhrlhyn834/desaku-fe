...
const _sfc_main = {
  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "flex-1 animate-fade block px-[2rem] sm:px-[6rem] md:px-[3rem] lg:px-[10rem] xl:px-[14rem] pt-6" }, _attrs))} data-v-aae865cc>`);
      _push(ssrRenderComponent(_component_BreadCrumb, { child: unref(category_name) }, {
        root: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span data-v-aae865cc${_scopeId}>Potensi Desa</span>`);
          } else {
            return [
              createVNode("span", {
      ...
      _push(`<div class="grid grid-cols-1 md:grid-cols-6 md:gap-x-12" data-v-aae865cc><div class="block col-span-1 md:col-span-4" data-v-aae865cc><div class="text-[#0088CC] border-[#0088CC] border-b-2 mb-6 text-xl md:text-2xl font-semibold py-3" data-v-aae865cc><span data-v-aae865cc>Potensi Desa: ${ssrInterpolate(unref(category_name))} Halaman ${ssrInterpolate(unref(page))}</span></div>`);
      if (unref(potensi).length > 0) {
        _push(`<!--[-->`);
        ssrRenderList(unref(potensi), (potensi2) => {
          _push(`<div class="cursor-pointer flex mb-[0.5rem] md:mb-2 h-[160px] md:h-[200px]" data-v-aae865cc><div class="h-[120px] sm:h-[160px] w-[140px] sm:w-[220px] md:w-[260px] flex-none" data-v-aae865cc>`);
          ...
          _push(`</div><div class="block pl-4" data-v-aae865cc><div class="tetx-base md:text-xl font-semibold" data-v-aae865cc><span class="line-clamp-2" data-v-aae865cc>${ssrInterpolate(potensi2.title)}</span></div><div class="block md:flex" data-v-aae865cc><div class="text-xs md:text-base flex items-center font-medium mt-2" data-v-aae865cc>`);
          _push(ssrRenderComponent(_component_IconsDate, { class: "flex-none" }, null, _parent));
          _push(`<span class="ml-1" data-v-aae865cc>${ssrInterpolate(unref(moment)(potensi2.created_at).format("LL"))}</span></div><div class="text-xs md:text-base flex items-center font-medium mt-2 sm:ml-2" data-v-aae865cc>`);
          _push(ssrRenderComponent(_component_IconsTag, { class: "flex-none" }, null, _parent));
          _push(`<span class="ml-1" data-v-aae865cc>${ssrInterpolate(potensi2.category_name)}</span></div></div><div class="mt-2 text-sm md:text-base" data-v-aae865cc><span class="line-clamp-2 sm:line-clamp-3" data-v-aae865cc>${ssrInterpolate(potensi2.description)}</span></div></div></div>`);
        });
        _push(`<!--]-->`);
      } else {
      ...
      _push(`</div><div class="col-span-2" data-v-aae865cc>`);
...
const _id_ = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-aae865cc"]]);

export { _id_ as default };
//# sourceMappingURL=_id_-788f80fc.mjs.map
