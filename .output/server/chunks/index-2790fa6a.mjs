...
const _sfc_main$2 = {
  ...
  async setup(__props) {
    ...
    ref(null);
    images.value = ([__temp, __restore] = withAsyncContext(() => $fetch("/api/image-gallery?limit=8")), __temp = await __temp, __restore(), __temp);
    return (_ctx, _push, _parent, _attrs) => {
      const _component_v_img = resolveComponent("v-img");
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "block col-span-4" }, _attrs))} data-v-544fdf83><div class="text-[#0088CC] border-[#0088CC] border-b-2 mb-6 text-xl md:text-2xl font-semibold py-3" data-v-544fdf83><span data-v-544fdf83>Galeri Desa</span></div><div id="gallery" class="sm:grid rounded-lg hidden grid-cols-1 md:grid-cols-4 mb-2 gap-6" data-v-544fdf83><!--[-->`);
      ssrRenderList(unref(images), (image, key) => {
        _push(`<a class="rounded-lg h-full w-full relative"${ssrRenderAttr("href", image.url)} data-pswp-width="600" data-pswp-height="400" target="_blank" rel="noreferrer" data-v-544fdf83>`);
        _push(ssrRenderComponent(_component_v_img, {
          "lazy-src": image.url,
          class: "rounded-md",
          cover: "",
        ...
        _push(`<div class="rounded-b-lg z-10 py-1 backdrop-blur-xl opacity-90 pl-2 bg-[#0088CC] bottom-0 absolute w-full text-white" data-v-544fdf83><p class="truncate text-sm md:text-base" data-v-544fdf83>${ssrInterpolate(image.description)}</p></div></a>`);
      });
      _push(`<!--]--></div><div id="gallery" class="sm:hidden rounded-lg grid grid-cols-1 md:grid-cols-4 mb-2 gap-6" data-v-544fdf83></div></div>`);
    };
  }
};
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-544fdf83"]]);
const _sfc_main$1 = {
  __name: "Location",
  __ssrInlineRender: true,
  async setup(__props) {
...
//# sourceMappingURL=index-2790fa6a.mjs.map
