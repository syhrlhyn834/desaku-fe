  ...
  async setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(unref(announcements), (announcement) => {
        ...
        _push(`<span class="ml-1">${ssrInterpolate(unref(moment)(announcement.created_at).format("LL"))}</span></div><div class="flex items-center sm:ml-2">`);
...
//# sourceMappingURL=index-2a892d9d.mjs.map
