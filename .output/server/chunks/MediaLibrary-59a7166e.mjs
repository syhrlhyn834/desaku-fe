              ...
              text: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  if (currentTab.value == "listImage") {
                    ...
                    _push3(`</div><div class="mt-3"${_scopeId2}><span${_scopeId2}>mimes: jpeg,png,jpg | max: 1mb</span></div></div></div></div>`);
                  }
                  _push3(`</div>`);
                } else {
                  return [
                        ...
                        createVNode("div", mergeProps({ class: "flex justify-center items-center h-[300px]" }, unref(getRootProps)()), [
                          ...
                          createVNode("div", null, [
                            ...
                            createVNode("div", { class: "mt-3" }, [
                              createVNode("span", null, "mimes: jpeg,png,jpg | max: 1mb")
                            ])
                          ])
                        ], 16)
                      ]))
...
//# sourceMappingURL=MediaLibrary-59a7166e.mjs.map
