...
import { resolveComponent, withCtx, createVNode, openBlock, createBlock, unref, toDisplayString, createCommentVNode, useSSRContext } from 'vue';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_v_data_table, {
        ...
        "item.date": withCtx(({ value }, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<span${_scopeId}>${ssrInterpolate(unref(moment)(value).format("DD MMM YYYY"))}</span>`);
          } else {
            return [
              createVNode("span", null, toDisplayString(unref(moment)(value).format("DD MMM YYYY")), 1)
            ];
          }
        }),
...
//# sourceMappingURL=index-0e84c138.mjs.map
